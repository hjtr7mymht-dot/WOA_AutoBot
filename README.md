...
> **声明：此脚本完全免费，仅供个人非商业使用。严禁倒卖、转售或任何形式的商业获利。**
> 若你通过付费渠道获得，请立即退款并举报。
...
本软件采用 **"个人非商用、禁止倒卖"** 许可协议。

- ✅ **免费个人使用** — 任何人都可以免费下载和使用
- ✅ **修改与学习** — 欢迎学习源码并进行个性化修改
- 🚫 **禁止倒卖** — 严禁在淘宝、闲鱼、拼多多、微信群、QQ群等任何渠道出售或变相收费
- 🚫 **禁止商业用途** — 未经作者明确授权，禁止任何商业使用
- ⚠️ **仅作者保留商业权利** — 所有出售、授权、商业分发权利排他性地保留给原作者

完整协议请阅读 [LICENSE](LICENSE) 文件。

**如您通过任何付费渠道获得本软件，请立即退款并举报。**
